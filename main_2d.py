...
if __name__ == "__main__":
    ...
    plt.yscale("log")
    plt.tight_layout()
    plt.savefig("/home/s4861264/CIT_project/optimization_history_2d.png")
    plt.close()
    ...
    plot_reconstruction_2d(
        ...
        save_path="/home/s4861264/CIT_project/original_reconstruction_2d.png",
    )

    plot_reconstruction_2d(
        final_reconstruction,
        title="Corrected Reconstruction",
        save_path="/home/s4861264/CIT_project/final_reconstruction_2d.png",
    )
    ...
    plot_comparison_2d(
        ...
        save_path="/home/s4861264/CIT_project/comparison_2d.png",
    )
    ...
    plot_segmentation_comparison_2d(
        ...
        save_path="/home/s4861264/CIT_project/comparison_threshold_2d.png",
    )
